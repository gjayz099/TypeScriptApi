...
Passenger.init(
    {
        ...
        Gender: {
            type: DataTypes.STRING(10),  // Max length for gender (e.g., 'Male', 'Female')
            allowNull: true,
        },
        Nationality: {
            type: DataTypes.STRING(100),  // Max length for nationality
            allowNull: true,
        },
        PassportNumber: {
            type: DataTypes.STRING(50),  // Max length for passport number
            allowNull: true,
        },
        Email: {
            type: DataTypes.STRING(255),  // Max length for email
            allowNull: true,
            unique: true,  // Ensure email is unique
        },
        PhoneNumber: {
            type: DataTypes.STRING(20),  // Use STRING for phone number to handle symbols like + and -
            allowNull: true,
        },
        EmergencyContact: {
            type: DataTypes.STRING(255),  // Max length for emergency contact info
            allowNull: true,
        },
        CreateDate: {
